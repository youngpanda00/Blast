...
export const InstagramPostComponent: React.FC<InstagramPostComponentProps> = ({
          ...
          <div className="flex items-center justify-between p-2 border-b border-gray-100">
            <div className="flex items-center gap-2">
              ...
              <div className="w-5 h-5 rounded-full overflow-hidden">
                <img
                  src="https://cdn.lofty.com/image/fs/servicetool/2025717/7/original_ec07ec59d797461a.png"
                  alt="Profile"
                  className="w-full h-full object-cover"
                />
              </div>
  ...
  return (
    <div className="w-[calc(100vw-65px)] max-w-[390px] h-[366px] bg-white rounded-xl shadow-[0px_4px_30px_0px_rgba(32,36,55,0.08)] relative overflow-hidden">
      {/* Header */}
      <div className="absolute top-[11px] left-[15px] h-[30px] flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-[30px] h-[30px] rounded-full border border-[#DEDFE0] bg-white overflow-hidden">
            <img
