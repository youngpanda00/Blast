            ...
            <div className="w-full text-center max-md:text-center">
              ...
              <div className="hidden max-md:block">
                <h1 className="text-[36px] font-bold text-white tracking-[-1px] leading-[1.1] mb-4">
                  1-Clicking Listing to Leads
                </h1>
                <h2 className="text-[18px] font-normal text-white/80 leading-[1.4]">
      ...
      <section className="md:hidden w-full bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50 border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-8 max-md:py-6">
          <div className="text-center">
            {/* Stats bar */}
            <div className="flex items-center justify-center gap-8 max-md:gap-12 mb-8 max-md:mb-6">
              <div className="flex items-center gap-2 max-md:flex-col max-md:gap-0 text-sm max-md:text-xs">
                <div className="w-8 h-8 max-md:hidden bg-blue-100 rounded-full flex items-center justify-center">
                  <TrendingUp className="w-4 h-4 text-blue-600" />
                </div>
                <span className="font-medium text-gray-700 max-md:text-center max-md:leading-tight whitespace-nowrap">
                  <span className="max-md:block max-md:text-3xl max-md:font-bold max-md:leading-10">2K+</span>
                  <span className="max-md:block max-md:text-lg max-md:font-normal"> views</span>
                </span>
              </div>
              <div className="flex items-center gap-2 max-md:flex-col max-md:gap-0 text-sm max-md:text-xs">
                ...
                <span className="font-medium text-gray-700 max-md:text-center max-md:leading-tight whitespace-nowrap">
                  <span className="max-md:block max-md:text-3xl max-md:font-bold max-md:leading-10">Live</span>
                  <span className="max-md:block max-md:text-lg max-md:font-normal"> 24hrs</span>
                </span>
              </div>
              <div className="flex items-center gap-2 max-md:flex-col max-md:gap-0 text-sm max-md:text-xs">
                ...
                <span className="font-medium text-gray-700 max-md:text-center max-md:leading-tight whitespace-nowrap">
                  <span className="max-md:block max-md:text-3xl max-md:font-bold max-md:leading-10">9+</span>
                  <span className="max-md:block max-md:text-lg max-md:font-normal"> leads</span>
                </span>
              </div>
            </div>
