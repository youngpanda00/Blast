...
export const Hero: React.FC<{ page?: "listing" }> = ({ page }) => {
  return (
    <>
      ...
      <section className={page !== 'listing' ? "flex w-full flex-col items-stretch px-[22px] pt-[30px] pb-[50px] max-md:max-w-full max-md:px-4 max-md:pb-[30px] max-md:pt-[25px] bg-[rgba(0,28,188,1)]" :
