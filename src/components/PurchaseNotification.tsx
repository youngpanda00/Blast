...
const PurchaseNotification: React.FC<PurchaseNotificationProps> = ({
  ...
  useEffect(() => {
    const scheduleNextUpdate = () => {
      // Random interval between 10-15 seconds for more realistic timing
  ...
  return (
    <div className={`fixed right-4 z-40 max-w-[310px] sm:max-w-none hidden sm:block transition-all duration-300 ease-in-out transform top-[calc(var(--promo-banner-space,0px)+4rem)] ${
      isVisible
