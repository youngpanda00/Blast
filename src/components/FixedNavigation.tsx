...
export const FixedNavigation: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 bg-white px-[22px] max-md:px-5 h-[60px] flex items-center border-b border-gray-100 transition-all duration-300 ${
      isAtTop ? 'nav-transparent' : ''
    }`}>
      <div className="w-full max-w-[1210px] mx-auto flex items-center h-full">
        {/* Logo */}
