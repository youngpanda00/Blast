...
export const FixedNavigation: React.FC = () => {
  ...
  const loftyHref = utmSource && utmSource.trim().length > 0 ? `https://${loftyDomain}/?fromblast=2&sourceDomain=${sourceDomain}&utm_source=${encodeURIComponent(utmSource)}` : `https://${loftyDomain}/?fromblast=2&sourceDomain=${sourceDomain}`;
