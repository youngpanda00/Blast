...
export const FixedNavigation: React.FC = () => {
  ...
  const loftyHref = utmSource && utmSource.trim().length > 0 ? `https://lofty.com/?fromblast=2&sourceDomain=${window.location.hostname}&utm_source=${encodeURIComponent(utmSource)}` : `https://lofty.com/?fromblast=2&sourceDomain=${window.location.hostname}`;
