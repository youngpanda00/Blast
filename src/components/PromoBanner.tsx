...
export const PromoBanner: React.FC<Props> = ({ theme, visible, percent, expiresAt, clearPromo, onBlastNow }) => {
  ...
  return (
    <div id="promo-banner" data-promo-banner className={`fixed flex left-0 right-0 top-[50px] md:top-[60px] z-40 shadow-lg ${theme === 'christmas' ? 'bg-[#184e02]' : 'bg-gradient-to-r from-[#547AF2] via-[#7A5AF8] to-[#9B5CF6]'}`} style={{paddingLeft: isMobile ? 0 : '100px'}}>
      ...
      <div className="flex items-center justify-center max-md:hidden" style={{position: 'relative', width: '280px', marginRight: '50px'}}>
        ...
        <div onClick={onBlastNow} className='flex items-center justify-center' style={{width: '180px', height: '36px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', borderRadius: '100px', gap: '10px', color: '#ffffff', background: "linear-gradient(90.11deg, #FFBE44 -3.33%, #FA7E20 100.86%)", boxShadow: '0px 10px 30px 0px rgba(255, 68, 2, 0.2)'}}>Launch Your Ad 
