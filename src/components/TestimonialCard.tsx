  ...
  return (
    <>
      <div
        ...
        style={{ width: '100%', height: '250px',  background: "linear-gradient(90deg, #3B5CDE 0%, #7340D8 100%)" }}
      >
        <img style={{ width: '100%', height: '250px', objectFit: 'cover', zIndex: 10, opacity: 0.2 }} src="https://cdn.lofty.com/image/fs/servicetool/2026228/5/original_8bc2b13de4a44b74.png" alt="Testimonial bg" className="w-full h-full object-cover absolute top-0 left-0" />
        <div className="w-full h-full object-cover absolute flex items-center justify-center cursor-pointer transition-colors" style={{ width: '54px', height: '54px', background: isHovered ? 'rgba(81,96,102,1)' : 'rgba(81,96,102,0.6)', zIndex: 11, top: '50%', left: '50%', transform: 'translate(-50%, -50%)', borderRadius: '50%' }} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} onClick={() => { if (videoUrl) setShowVideo(true); }}>
